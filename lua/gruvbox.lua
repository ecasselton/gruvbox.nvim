...
local function get_groups()
  ...
  local groups = {
    ...
    MatchParen = { bg = colors.bg3, bold = config.text_style.emphasis.bold },
    ...
    WildMenu = { fg = colors.blue, bg = colors.bg2, bold = config.text_style.emphasis.bold },
    Directory = { fg = colors.blue, bold = config.text_style.emphasis.bold },
    Title = { fg = colors.green, bold = config.text_style.emphasis.bold },
    ErrorMsg = { fg = colors.bg0, bg = colors.red, bold = config.text_style.emphasis.bold },
    MoreMsg = { link = "GruvboxYellowBold" },
    ModeMsg = { link = "GruvboxYellowBold" },
    Question = { fg = colors.orange, bold = config.text_style.emphasis.bold },
    WarningMsg = { fg = colors.red, bold = config.text_style.emphasis.bold },
    LineNr = { fg = colors.bg4 },
    SignColumn = config.transparent_mode and { bg = nil } or { bg = colors.bg1 },
    Folded = { fg = colors.gray, bg = colors.bg1, italic = config.text_style.folds.italic },
    ...
    Comment = { fg = colors.gray, italic = config.text_style.comments.italic },
    Todo = { fg = colors.bg0, bg = colors.yellow, bold = config.text_style.comments.bold, italic = config.text_style.comments.italic },
    Done = { fg = colors.orange, bold = config.text_style.comments.bold, italic = config.text_style.comments.italic },
    Error = { fg = colors.red, bold = config.text_style.emphasis.bold, reverse = config.inverse },
    Statement = { link = "GruvboxRed" },
    Conditional = { link = "GruvboxRed" },
    Repeat = { link = "GruvboxRed" },
    Label = { link = "GruvboxRed" },
    Exception = { link = "GruvboxRed" },
    Operator = { fg = colors.orange, italic = config.text_style.operators.italic },
    Keyword = { link = "GruvboxRed" },
    Identifier = { link = "GruvboxBlue" },
    Function = { fg = colors.green, bold = config.text_style.functions.bold },
    ...
    String = { fg = colors.green, italic = config.text_style.strings.italic },
    ...
    PmenuSel = { fg = colors.bg2, bg = colors.blue, bold = config.text_style.emphasis.bold },
    ...
    LspReferenceWrite = { fg = colors.orange, bold = config.text_style.emphasis.bold },
    ...
    TelescopeSelection = { fg = colors.orange, bold = config.text_style.emphasis.bold },
    ...
    CmpItemAbbrMatch = { fg = colors.blue, bold = config.text_style.emphasis.bold },
    ...
    htmlTag = { fg = colors.aqua, bold = config.text_style.emphasis.bold },
    htmlEndTag = { fg = colors.aqua, bold = config.text_style.emphasis.bold },
    ...
    htmlBoldUnderline = { fg = colors.fg0, bg = colors.bg0, bold = true, underline = config.underline },
    ...
    xmlTag = { fg = colors.aqua, bold = config.text_style.emphasis.bold },
    xmlEndTag = { fg = colors.aqua, bold = config.text_style.emphasis.bold },
    xmlTagName = { link = "GruvboxBlue" },
    xmlEqual = { link = "GruvboxBlue" },
    docbkKeyword = { fg = colors.aqua, bold = config.text_style.emphasis.bold },
    ...
    clojureRegexpCharClass = { fg = colors.fg3, bold = config.text_style.emphasis.bold },
    ...
    pythonDottedName = { fg = colors.green, bold = config.text_style.emphasis.bold },
    ...
    markdownH1 = { fg = colors.green, bold = config.text_style.emphasis.bold },
    markdownH2 = { fg = colors.green, bold = config.text_style.emphasis.bold },
    ...
    haskellBottom = { fg = colors.red, bold = config.text_style.emphasis.bold },
    haskellImportKeywords = { fg = colors.purple, bold = config.text_style.keywords.bold },
    ...
    haskellPragma = { fg = colors.red, bold = config.text_style.emphasis.bold },
    haskellTH = { fg = colors.aqua, bold = config.text_style.emphasis.bold },
    ...
    haskellQuote = { fg = colors.green, bold = config.text_style.emphasis.bold },
    haskellShebang = { link = "GruvboxYellowBold" },
    haskellLiquid = { fg = colors.purple, bold = config.text_style.emphasis.bold },
    haskellQuasiQuoted = { fg = colors.blue, bold = config.text_style.emphasis.bold },
    haskellRecursiveDo = { link = "GruvboxPurple" },
    haskellQuotedType = { link = "GruvboxRed" },
    haskellPreProc = { link = "GruvboxFg4" },
    haskellTypeRoles = { fg = colors.red, bold = config.text_style.emphasis.bold },
    ...
    csInterpolationAlignDel = { fg = colors.aqua, bold = config.text_style.emphasis.bold },
    csInterpolationFormat = { link = "GruvboxAqua" },
    csInterpolationFormatDel = { fg = colors.aqua, bold = config.text_style.emphasis.bold },
    ...
    LspSagaCodeActionContent = { fg = colors.green, bold = config.text_style.emphasis.bold },
    LspSagaLspFinderBorder = { link = "GruvboxFg1" },
    LspSagaAutoPreview = { link = "GruvboxOrange" },
    TargetWord = { fg = colors.blue, bold = config.text_style.emphasis.bold },
    ...
    DiffviewStatusModified = { fg = colors.green, bold = config.text_style.emphasis.bold },
    DiffviewFilePanelInsertions = { fg = colors.green, bold = config.text_style.emphasis.bold },
    DiffviewFilePanelDeletions = { fg = colors.red, bold = config.text_style.emphasis.bold },
    ...
    ["@text.strong"] = { bold = config.text_style.emphasis.bold },
    ["@text.emphasis"] = { italic = config.text_style.emphasis.italic},
    ...
    ["@text.note.comment"] = { fg = colors.purple, bold = config.text_style.comments.bold },
    ["@text.warning"] = { link = "WarningMsg" },
    ["@text.danger"] = { link = "ErrorMsg" },
    ["@text.danger.comment"] = { fg = colors.fg0, bg = colors.red, bold = config.text_style.comments.bold },
